    ...
    <tbody id="entryformtbody">
            ...
            ?>
             <tr>
                            ...
                            <td> 
                                <?= $form->field($eitems[$key], '['.$key.']dr_amount')->label(false)->textInput(['maxlength' => true,'class'=>'dr-amount']) ?>
                            </td>
                            <td>
                                <?= $form->field($eitems[$key], '['.$key.']cr_amount')->label(false)->textInput(['maxlength' => true,'class'=>'cr-amount']) ?>
                            </td>
                            <td>
