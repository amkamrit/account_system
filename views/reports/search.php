...
<div style="margin:10px;" class="hidden-print">
		<button id="toggleSearch" class="btn btn-info">EXPAND SEARCH</button>
		<?= Html::a('EXPORT TO CSV', Yii::$app->request->baseUrl.'/'.Yii::$app->controller->id.'/'.Yii::$app->controller->action->id.'?export=csv', ['class'=>'btn btn-info pull-right hidden-print','data-method' => 'POST','data-params' => [
